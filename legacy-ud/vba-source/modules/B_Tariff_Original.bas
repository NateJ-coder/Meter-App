Attribute VB_Name = "B_Tariff_Original"
...
'
'    Public SQ1 As Double
'    Public ST1 As Double
'
...
'
'  Public Function LoadTarrifs(TarrifName As String) As Boolean
...
'
'  ' Search for "TarrifName" to start
'
'    Index = 1
'    ThisCell = Sheets("Tariffs").Cells(Index, 2)
'    While ThisCell <> TarrifName
'        Index = Index + 1
'        ThisCell = Sheets("Tariffs").Cells(Index, 2)
'        If Index = 1000 Then
'            MsgBox ("No Tarrif Title: " & TarrifName)
'            LoadTarrifs = False
'            Exit Function
'        End If
'    Wend
...
'    OffsetCol = 9
'
'      ' OCD = Other Charges Description
'For i = 0 To 7
'
'    OtherChargesDesc(i + 1) = Sheets("Tariffs").Cells(OffsetRow + i, OffsetCol)
'    OtherChargesTariff(i + 1) = Sheets("Tariffs").Cells(OffsetRow + i, OffsetCol + 1)
'
'Next
'LoadTarrifs = True
'
...
'
'       '  If GetConsumption > 2000 Then GetConsumption = 0
'
'    Else
...
'    If LoadTarrifs(TariffName) = False Then ' Load the ELECTRICITY and WATER Tariff Tables
'
'    End If
'
'
...
'
'    ' Quantities
'    EQ1 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow, OffsetCol), "<") + 1))
'    EQ2 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 1, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 1, OffsetCol), "<") + 1))
'    EQ3 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 2, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 2, OffsetCol), "<") + 1))
'    EQ4 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 3, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 3, OffsetCol), "<") + 1))
'    EQ5 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 4, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 4, OffsetCol), "<") + 1))
'    EQ6 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 5, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 5, OffsetCol), "<") + 1))
'    EQ7 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 6, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 6, OffsetCol), "<") + 1))
'    EQ8 = CDbl(Mid(Sheets("TariffTester").Cells(OffsetRow + 7, OffsetCol), InStr(Sheets("TariffTester").Cells(OffsetRow + 7, OffsetCol), "<") + 1))
'
'    ' Tarrif Charges
'    ET1 = Sheets("TariffTester").Cells(OffsetRow, OffsetCol + 1)
'    ET2 = Sheets("TariffTester").Cells(OffsetRow + 1, OffsetCol + 1)
'    ET3 = Sheets("TariffTester").Cells(OffsetRow + 2, OffsetCol + 1)
'    ET4 = Sheets("TariffTester").Cells(OffsetRow + 3, OffsetCol + 1)
'    ET5 = Sheets("TariffTester").Cells(OffsetRow + 4, OffsetCol + 1)
'    ET6 = Sheets("TariffTester").Cells(OffsetRow + 5, OffsetCol + 1)
'    ET7 = Sheets("TariffTester").Cells(OffsetRow + 6, OffsetCol + 1)
'    ET8 = Sheets("TariffTester").Cells(OffsetRow + 7, OffsetCol + 1)
'
'
'
'    EQ1x = EQ1 * Units
